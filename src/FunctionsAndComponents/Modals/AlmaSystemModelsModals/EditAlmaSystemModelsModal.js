...
export default function EditAlmaSystemModelsModal({ isOpen, onRequestClose, edit, refresh }) {
    ...
    const handelSave = async () => {
        if (handelFormValid()) {
            await PutData(Urls['AlmaSystemModels'], editItem.id, editItem)
            refresh()
    ...
    return (
        ...
        >
            <div className="add-modal-container">
                <h2>აპარატის მოდელის რედაქტირება</h2>
